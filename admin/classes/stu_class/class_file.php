...
public function add_class_info($data){
    ...
    public function view_all_class_info(){

     //   $query ="SELECT * FROM class";


     $query ="SELECT class.class_id, class.class_name,class.class_note,teacher.tc_name
      FROM class INNER JOIN teacher ON class.tc_id=teacher.tc_id";
